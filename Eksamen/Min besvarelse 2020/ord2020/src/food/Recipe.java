...
public class Recipe {
	...
	public Recipe createNPortions(int n) {
		Recipe newRecipe = new Recipe(getName(), getCategory(), n, getIngredients());
		return newRecipe;
	}
	
	
	public Recipe createNPortionsUsingDelegation(Ingredients ingredients, double scale) {
		ScaledIngredients scaled = new ScaledIngredients(ingredients,scale);
		Recipe newRecipe = new Recipe(getName(), getCategory(), (int) scaled.getScale(), scaled.getIngredients());
		return newRecipe;
	}
